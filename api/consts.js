...
// [必填] 请替换为你自己的 OpenID (在 Vercel 日志中查看，或发送消息后看后台)
...
// 【核心逻辑】生成双向映射，支持 'jp':'jp'
// 彻底解决输入代码或按钮回传代码时查不到的问题
Object.keys(ALL_SUPPORTED_REGIONS).forEach(key => {
  const code = ALL_SUPPORTED_REGIONS[key];
  ALL_SUPPORTED_REGIONS[code] = code;
});
